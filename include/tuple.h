...
class Tuple : public Tuple<typeN...>
{
    ...
    public:
        ...
        /**
            ...
            **/
        Tuple(typeT n0, typeN... nn) : Tuple<typeN...>(nn...), m_n0(n0) { }
...
{
    public:
        static auto Value(const Tuple<typeT, typeN...> *t) -> decltype(ValueAt<index - 1, typeN...>::Value(t))
        {
...
/**
    ...
    */
template <std::size_t index, typename typeT, typename... typeN>
auto Get(const Tuple<typeT, typeN...> &t) -> decltype(ValueAt<index, typeT, typeN...>::Value(&t))
{
